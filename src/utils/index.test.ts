...
describe('utils', () => {
  describe('#getEtherscanLink', () => {
    ...
    // })
    // it('enum', () => {
    //   expect(getEtherscanLink(ChainId.ONENESSDEV, 'abc', 'address')).toEqual('https://rinkeby.etherscan.io/address/abc')
    // })
  })
  ...
  describe('#isAddress', () => {
    ...
    it('returns the checksummed address', () => {
      expect(isAddress('0xb128A49f1382c942A5Ca3BDa7227cC464D2B08E0')).toBe('0xb128A49f1382c942A5Ca3BDa7227cC464D2B08E0')
      expect(isAddress('0xb128A49f1382c942A5Ca3BDa7227cC464D2B08E0')).toBe('0xb128A49f1382c942A5Ca3BDa7227cC464D2B08E0')
    })

    it('succeeds even without prefix', () => {
      expect(isAddress('f164fc0ec4e93095b804a4795bbe1e041497b92a')).toBe('0xb128A49f1382c942A5Ca3BDa7227cC464D2B08E0')
    })
  ...
  describe('#shortenAddress', () => {
    ...
    it('truncates middle characters', () => {
      expect(shortenAddress('0xb128A49f1382c942A5Ca3BDa7227cC464D2B08E0')).toBe('0xf164...b92a')
    })
