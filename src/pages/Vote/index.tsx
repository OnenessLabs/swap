  ...
  return (
    <PageWrapper gap="lg" justify="center">
      ...
      <TopSection gap="md">
        <VoteCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>OnenessSwap Governance</TYPE.white>
              </RowBetween>
              <RowBetween>
                <TYPE.white fontSize={14}>
                  OST tokens represent voting shares in OnenessSwap governance. You can vote on each proposal yourself
                  or delegate your votes to a third party.
                </TYPE.white>
              </RowBetween>
              <ExternalLink
                style={{ color: 'white', textDecoration: 'underline' }}
                href="https://onenesslabs.io"
                target="_blank"
              >
                <TYPE.white fontSize={14}>Read more about OnenessSwap governance</TYPE.white>
              </ExternalLink>
            </AutoColumn>
          </CardSection>
          <CardBGImage />
      ...
      <TYPE.subHeader color="text3">
        A minimum threshhold of 1% of the total OST supply is required to submit proposals
      </TYPE.subHeader>
    </PageWrapper>
  )
}
