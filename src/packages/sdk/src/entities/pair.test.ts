...
describe('computePairAddress', () => {
  it('should correctly compute the pool address', () => {
    const tokenA = new Token(ChainId.MAINNET, '0x9BF054279893C80C84cd8C74C3be299BaB9C8a29', 18, 'USDC', 'USD Coin')
  ...
  it('should give same result regardless of token order', () => {
    const USDC = new Token(ChainId.MAINNET, '0x9BF054279893C80C84cd8C74C3be299BaB9C8a29', 18, 'USDC', 'USD Coin')
...
describe('Pair', () => {
  ...
  describe('constructor', () => {
    it('cannot be used for tokens on different chains', () => {
      expect(() => new Pair(new TokenAmount(USDC, '100'), new TokenAmount(WETH[ChainId.ONENESSDEV], '100'))).toThrow(
        'CHAIN_IDS'
      )
    })
  })
  ...
  describe('miscellaneous', () => {
    it('getLiquidityMinted:0', async () => {
      const tokenA = new Token(ChainId.ONENESSDEV, '0x0000000000000000000000000000000000000001', 18)
      const tokenB = new Token(ChainId.ONENESSDEV, '0x0000000000000000000000000000000000000002', 18)
